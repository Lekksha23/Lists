...
namespace List.Tests
{
        public class DoublyLinkedListTests
        {
            ...
            {
                //arrange
                DoublyLinkedList list1 = new DoublyLinkedList(arr1);
                DoublyLinkedList list2 = new DoublyLinkedList(arr2);
            ...
            [TestCase(new int[] { 3, 3, 3, 3 }, 0, 42, new int[] { 42, 3, 3, 3 })]
            ...
            [TestCase(0, new int[] { 5, 6, 7 }, new int[] { 6, 7 })]
            [TestCase(2, new int[] { 5, 6, 7 }, new int[] { 5, 6 })]
            [TestCase(1, new int[] { 5, 6, 7, 42 }, new int[] { 5, 7, 42 })]
